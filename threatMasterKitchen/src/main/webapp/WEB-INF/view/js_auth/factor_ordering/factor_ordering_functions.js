$(function(){
	...
	$("#submit-factor-ordering-questionnaire-btn").click(function(){
		...
		$("div.comparison-block").each(function(){
			...
			var comparisonOperator = $(this).find("input[name='comparison_motivating_operator_"+attackMotivatingFactorComparisonId+"_"+attackMotivatingFactorId+"']:checked").val();
			var comparisonJSON = {
		...
		$("div.comparison-block-vulnerability-enabling").each(function(){
			...
			var comparisonOperator = $(this).find("input[name='comparison_operator_"+vulnerabilityEnablingFactorComparisonId+"_"+vulnerabilityEnablingFactorId+"']:checked").val();
			var comparisonJSON = {
